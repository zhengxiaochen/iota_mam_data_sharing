...
const executeDataPublishing = async function() {	 
    ...
    for (i = 1; i < 101; i++) {
       ...
       const json = JSON.parse(textByLine[0]); 
       ...
       //print results  "t":20190110081500,"tre:":0
       console.log(`waiting_time:${watingtime}`); 
       console.log(`t: ${json.t}, tre: ${json.tre}`);
    }  	
}
...
//ROOT IN THIS CASE: XWLWVYLVBJHLLSFBWFJMHGWAELURPQRXKBOXOXIKJNGKIVODXZPCBQ9LMMIFPTFICTHPQKMECQSHFGV9V
